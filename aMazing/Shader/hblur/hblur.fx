...
PS_INPUT VSEntry(VS_INPUT input)
{
	...
	output.blur3 = input.Tex + float2(texelSize * -2.0f ,0.0f);
	output.blur4 = input.Tex + float2(texelSize * -1.0f ,0.0f);
	output.blur5 = input.Tex + float2(texelSize * 0.0f ,0.0f);
	output.blur6 = input.Tex + float2(texelSize * 1.0f ,0.0f);
	output.blur7 = input.Tex + float2(texelSize * 2.0f ,0.0f);
	output.blur8 = input.Tex + float2(texelSize * 3.0f ,0.0f);
	output.blur9 = input.Tex + float2(texelSize * 4.0f ,0.0f);
	return output;
}
