...
sampler2D Map__20Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__20>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__18Sampler = sampler_state  // TexCoord1 
{ 
   Texture = <Map__18>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__21Sampler = sampler_state  // TexCoord2 
{ 
   Texture = <Map__21>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__23Sampler = sampler_state  // TexCoord3 
{ 
   Texture = <Map__23>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( Map__20Sampler, vout.TexCoord0 ); 
